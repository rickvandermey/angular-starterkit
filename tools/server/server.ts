...
import { ROUTES } from '../../apps/starterkit/src/app/routes/static.paths';
import { STATE_CB } from '../../apps/starterkit/src/app/ssr/tokens';
import { AppServerModule } from '../../apps/starterkit/src/main.server';

const isPrerender = process.argv[2] && process.argv[2] === 'prerender';

const PORT = process.env.PORT || 4201;
const DIST_FOLDER = join(process.cwd(), 'dist/apps/starterkit');
...
export * from '../../apps/starterkit/src/main.server';
